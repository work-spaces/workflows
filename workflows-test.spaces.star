...
_add_workflow_test("packages-test", ["node-sdk"])
_add_workflow_test("git-build", ["packages-test"])
_add_workflow_test("qemu-arm-build", ["git-build"], is_run = False)
_add_workflow_test("ninja-build", ["qemu-arm-build_checkout"])
...
_add_workflow_test("test1", ["sparse-checkout-test_checkout"], is_run = True)
