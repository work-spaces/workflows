...
capsule_checkout(
    "zstd",
    scripts = ["capsules/lock", "capsules/preload", "capsules/github.com/facebook/zstd-v1-capsule"],
...
capsule_checkout(
    "brotli_capsule",
    scripts = ["capsules/lock", "capsules/preload", "capsules/github.com/google/brotli-v1-capsule"],
    deps = ["@capsules/capsules"],
    prefix = "sysroot",
)
